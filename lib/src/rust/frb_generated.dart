...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -834259351;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiUserClearLoginInfo();

  Future<void> crateApiReceivingClearReceivingTasks(
  ...
  Future<String> crateApiPropertyGetProperty({required String key});
  ...
  Future<void> crateApiSystemOpenFile({required String path});

  Future<void> crateApiReceivingReceivingTaskSetRemoved(
      {required String taskId, required PlatformInt64 reason});

  Stream<ReceivingTask> crateApiReceivingRegisterReceived();
  ...
  Future<void> crateApiSpaceRenameDevice(
  ...
  Future<void> crateApiDownloadSetDownloadConfigOnlyPath(
  ...
  Future<void> crateApiPropertySetProperty(
      {required String key, required String value});

  Future<void> crateApiSystemShowFileInExplorer({required String path});
  ...
  Future<void> crateApiReceivingUnregisterReceived();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiUserClearLoginInfo() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiUserClearLoginInfoConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiUserClearLoginInfoConstMeta => const TaskConstMeta(
        debugName: "clear_login_info",
        argNames: [],
      );
  ...
  Future<void> crateApiReceivingClearReceivingTasks(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_list_receiving_task_clear_type(clearTypes, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 6, port: port_);
      },
      codec: SseCodec(
      ...
      constMeta: kCrateApiReceivingClearReceivingTasksConstMeta,
      argValues: [clearTypes],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiReceivingClearReceivingTasksConstMeta =>
      const TaskConstMeta(
        debugName: "clear_receiving_tasks",
        argNames: ["clearTypes"],
      );
  ...
  Future<void> crateApiSendingClearSendingTasks(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_list_sending_task_clear_type(clearTypes, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 7, port: port_);
      },
      codec: SseCodec(
      ...
      constMeta: kCrateApiSendingClearSendingTasksConstMeta,
      argValues: [clearTypes],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSendingClearSendingTasksConstMeta =>
      const TaskConstMeta(
        debugName: "clear_sending_tasks",
        argNames: ["clearTypes"],
      );
  ...
  Future<String> crateApiPropertyGetProperty({required String key}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPropertyGetPropertyConstMeta,
      argValues: [key],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPropertyGetPropertyConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiSystemOpenFile({required String path}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSystemOpenFileConstMeta,
      argValues: [path],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSystemOpenFileConstMeta => const TaskConstMeta(
        debugName: "open_file",
        argNames: ["path"],
      );
  ...
  Future<void> crateApiReceivingReceivingTaskSetRemoved(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_i_64(reason, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiReceivingReceivingTaskSetRemovedConstMeta,
      argValues: [taskId, reason],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiReceivingReceivingTaskSetRemovedConstMeta =>
      const TaskConstMeta(
        debugName: "receiving_task_set_removed",
        argNames: ["taskId", "reason"],
      );

  @override
  Stream<ReceivingTask> crateApiReceivingRegisterReceived() {
    final listener = RustStreamSink<ReceivingTask>();
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_StreamSink_receiving_task_Sse(listener, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiReceivingRegisterReceivedConstMeta,
      argValues: [listener],
      apiImpl: this,
    )));
  ...
  TaskConstMeta get kCrateApiReceivingRegisterReceivedConstMeta =>
      const TaskConstMeta(
        debugName: "register_received",
        argNames: ["listener"],
      );
  ...
  Future<void> crateApiSpaceRenameDevice(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_String(newDeviceName, serializer);
        sse_encode_i_32(newDeviceType, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiSpaceRenameDeviceConstMeta,
      argValues: [fileId, newDeviceName, newDeviceType],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSpaceRenameDeviceConstMeta => const TaskConstMeta(
        debugName: "rename_device",
        argNames: ["fileId", "newDeviceName", "newDeviceType"],
      );
  ...
  Future<void> crateApiDownloadSetDownloadConfigOnlyPath(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiDownloadSetDownloadConfigOnlyPathConstMeta,
      argValues: [path],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiDownloadSetDownloadConfigOnlyPathConstMeta =>
      const TaskConstMeta(
        debugName: "set_download_config_only_path",
        argNames: ["path"],
      );
  ...
  Future<void> crateApiPropertySetProperty(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPropertySetPropertyConstMeta,
      argValues: [key, value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPropertySetPropertyConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiSystemShowFileInExplorer({required String path}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiSystemShowFileInExplorerConstMeta,
      argValues: [path],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSystemShowFileInExplorerConstMeta =>
      const TaskConstMeta(
        debugName: "show_file_in_explorer",
        argNames: ["path"],
      );
  ...
  Future<void> crateApiReceivingUnregisterReceived() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiReceivingUnregisterReceivedConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiReceivingUnregisterReceivedConstMeta =>
      const TaskConstMeta(
        debugName: "unregister_received",
        argNames: [],
      );
  ...
  TaskConstMeta
      get kCrateApiSingleInstanceStreamUnregisterSiListenerConstMeta =>
          const TaskConstMeta(
            debugName: "unregister_si_listener",
            argNames: [],
          );
  ...
  List<ReceivingTaskClearType> dco_decode_list_receiving_task_clear_type(
    ...
    return (raw as List<dynamic>)
        .map(dco_decode_receiving_task_clear_type)
        .toList();
  }
  ...
  List<SendingTaskClearType> dco_decode_list_sending_task_clear_type(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_sending_task_clear_type)
        .toList();
  }
  ...
  ReceivingTask dco_decode_receiving_task(dynamic raw) {
    ...
    return ReceivingTask(
      ...
      fileRemoved: dco_decode_i_64(arr[8]),
    );
  }
  ...
  ReceivingTaskClearType dco_decode_receiving_task_clear_type(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return ReceivingTaskClearType.values[raw as int];
  }
  ...
  SendingTaskClearType dco_decode_sending_task_clear_type(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return SendingTaskClearType.values[raw as int];
  }
  ...
  SendingTaskType dco_decode_sending_task_type(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return SendingTaskType.values[raw as int];
  }
  ...
  List<ReceivingTaskClearType> sse_decode_list_receiving_task_clear_type(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ReceivingTaskClearType>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_receiving_task_clear_type(deserializer));
    }
    return ans_;
  }
  ...
  List<SendingTaskClearType> sse_decode_list_sending_task_clear_type(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <SendingTaskClearType>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_sending_task_clear_type(deserializer));
    }
    return ans_;
  }
  ...
  ReceivingTask sse_decode_receiving_task(SseDeserializer deserializer) {
    ...
    var var_fileRemoved = sse_decode_i_64(deserializer);
    return ReceivingTask(
        taskId: var_taskId,
        driveId: var_driveId,
        fileId: var_fileId,
  ...
  ReceivingTaskClearType sse_decode_receiving_task_clear_type(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return ReceivingTaskClearType.values[inner];
  }
  ...
  SendingTaskClearType sse_decode_sending_task_clear_type(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return SendingTaskClearType.values[inner];
  }
  ...
  SendingTaskType sse_decode_sending_task_type(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return SendingTaskType.values[inner];
  }
  ...
  void sse_encode_StreamSink_receiving_task_Sse(
    ...
    sse_encode_String(
        self.setupAndSerialize(
            codec: SseCodec(
          decodeSuccessData: sse_decode_receiving_task,
          decodeErrorData: sse_decode_AnyhowException,
        )),
        serializer);
  }
  ...
  void sse_encode_list_receiving_task_clear_type(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_receiving_task_clear_type(item, serializer);
    }
  }
  ...
  void sse_encode_list_sending_task_clear_type(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_sending_task_clear_type(item, serializer);
    }
  }
  ...
  void sse_encode_receiving_task(ReceivingTask self, SseSerializer serializer) {
    ...
    sse_encode_i_64(self.fileRemoved, serializer);
  }
