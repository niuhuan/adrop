...
// These functions are ignored because they are not marked as `pub`: `convert_err`, `down_to_file_with_password`, `download_count_up`, `download_file`, `download_folder`, `download_item`, `download_one_file`, `download_one_folder`, `exists_task_file_ids`, `first_init_receiving_tasks`, `get_download_url`, `list_files`, `need_continue_receive`, `notify_received`, `receiving_job`, `remove_cloud_file`, `set_receiving_task_by_id`, `sync_tasks_to_dart`, `take_file_name`
// These types are ignored because they are not used by any `pub` functions: `RECEIVED_CALL_BACKS`, `RECEIVE_LIMIT_TIME_FILE_COUNT`, `RECEIVE_LIMIT_TIME_FILE`, `RECEIVE_LIMIT_TIME_WIDTH_START`, `RECEIVE_LIMIT_TIME_WIDTH`, `RECEIVING_CALL_BACKS`, `RECEIVING_TASKS`
