...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -834259351;
...
fn wire__crate__api__user__clear_login_info_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::user::clear_login_info().await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__sending__add_sending_tasks_impl(port, ptr, rust_vec_len, data_len),
        2 => wire__crate__api__space__adrive_user_get_drive_info_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        3 => wire__crate__api__space__check_old_password_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__space__choose_old_device_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__user__clear_login_info_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__receiving__clear_receiving_tasks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__sending__clear_sending_tasks_impl(port, ptr, rust_vec_len, data_len),
        ...
        10 => wire__crate__api__download__default_download_path_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__crate__api__fs__desktop_root_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__download__download_config_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__download__download_info_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__space__file_item_default_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__property__get_property_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__space__has_set_password_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__init__init_path_impl(port, ptr, rust_vec_len, data_len),
        ...
        23 => wire__crate__api__receiving__list_receiving_tasks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__sending__list_sending_tasks_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__user__login_info_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__nope__match_selection_file_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__space__oauth_derive_info_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__system__open_by_browser_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__system__open_file_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__receiving__receiving_task_set_removed_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        32 => wire__crate__api__receiving__register_receiving_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        33 => wire__crate__api__sending__register_sending_listener_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        34 => wire__crate__api__single_instance_stream__register_si_listener_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        35 => wire__crate__api__space__rename_device_impl(port, ptr, rust_vec_len, data_len),
        36 => {
            wire__crate__api__download__save_download_info_impl(port, ptr, rust_vec_len, data_len)
        }
        37 => wire__crate__api__download__set_download_config_only_path_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__space__set_new_password_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__property__set_property_impl(port, ptr, rust_vec_len, data_len),
        40 => {
            wire__crate__api__system__show_file_in_explorer_impl(port, ptr, rust_vec_len, data_len)
        }
        41 => wire__crate__api__space__space_info_impl(port, ptr, rust_vec_len, data_len),
        ...
        45 => wire__crate__api__receiving__unregister_receiving_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        46 => wire__crate__api__sending__unregister_sending_listener_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        47 => wire__crate__api__single_instance_stream__unregister_si_listener_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
