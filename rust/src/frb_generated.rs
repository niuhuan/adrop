...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 651866657;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        6 => wire__crate__api__space__file_item_default_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__space__list_folder_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__space__oauth_derive_info_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__space__space_info_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__system__open_by_browser_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__user__login_info_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__user_setting__start_login_service_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__user_setting__stop_login_service_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
